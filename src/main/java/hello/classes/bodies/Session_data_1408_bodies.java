...
public class Session_data_1408_bodies {
    ...
    public String getBodyGetSession(String mdmOsnClient, String mdmOsnUser){
        return "{"+
                "	\"user\": {"+
                "		\"activeClient\": {"+
                "			\"mdmOsnClient\": \"" + mdmOsnClient + "\","+
                "			\"mdmPkbClient\": \"" + mdmOsnClient + "\","+
                "			\"mdmCode\": \"" + mdmOsnClient + "\","+
                ...
                "		\"firstName\": \"Ivan\","+
                "		\"ids\": {"+
                "			\"acUniqueClientNumber\": \"20059736\","+
                "			\"login\": \"testing_payments_022\","+
                "			\"mdmOsn\": \"" + mdmOsnUser +"\","+
                "			\"vtbBoIdUser\": 323920"+
                "		},"+
                "		\"lastName\": \"Ivanov\","+
    ...
    public String getSession_old(String mdmOsn){
        return "{"+
                "	\"user\": {"+
                "		\"activeClient\": {"+
                "			\"mdmOsnClient\": \"" + mdmOsn + "\","+
                ...
                "		}"+
                "	],"+
                "	\"sessionId\": \"12345678-d93b-4426-9526-db" + mdmOsn +"\","+
                "	\"firstFactor\": \"LOGIN\""+
                "}";
    }
